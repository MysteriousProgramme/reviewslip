...
const STRINGS = {
  en: {
    ...
    noMatches: "No topics match that.",
    done: "Done",
    ...
    placeholder: "Press Regenerate to write your first review.",
    generate: 'Generate',
    generateCount: 'Generate ({used}/{max})',
    ...
    notePlaceholder: 'The pool, breakfast, the view…',
  ...
  th: {
    ...
    searchTopics: "ค้นหาหัวข้อ",
    noMatches: "ไม่พบหัวข้อที่ตรงกับคำค้นหา",
    done: "เสร็จสิ้น",
    ...
    placeholder: "กด \"สร้างใหม่\" เพื่อเขียนรีวิวแรกของคุณ",
    generate: 'สร้างรีวิว',
    generateCount: 'สร้างรีวิว ({used}/{max})',
    ...
    notePlaceholder: 'สระว่ายน้ำ อาหารเช้า วิว…',
  ...
  zh: {
    ...
    lengthDetailed: '详细',
    reviewLabel: '您的评价',
    placeholder: "点击「重新生成」写下您的第一条评价。",
    generate: '生成评价',
    generateCount: '生成评价（{used}/{max}）',
    regenerate: '重新生成',
  ...
  ja: {
    ...
    placeholder: "「作り直す」を押して最初のレビューを作成してください。",
    generate: '作成する',
    generateCount: '作成する ({used}/{max})',
    regenerate: '作り直す',
  ...
  ko: {
    ...
    lengthDetailed: '자세히',
    reviewLabel: '내 리뷰',
    placeholder: "\"다시 생성\"을 눌러 첫 리뷰를 작성하세요.",
    generate: '리뷰 생성',
    generateCount: '리뷰 생성 ({used}/{max})',
    regenerate: '다시 생성',
  ...
  es: {
    ...
    noMatches: "Ningún tema coincide.",
    done: "Listo",
    ...
    placeholder: "Pulsa \"Generar otra\" para escribir tu primera reseña.",
    generate: 'Generar',
    generateCount: 'Generar ({used}/{max})',
    ...
    notePlaceholder: 'La piscina, el desayuno, las vistas…',
  ...
  fr: {
    ...
    searchTopics: "Rechercher un thème",
    noMatches: "Aucun thème ne correspond.",
    done: "Terminé",
    ...
    placeholder: "Touchez « Régénérer » pour écrire votre premier avis.",
    generate: 'Générer',
    generateCount: 'Générer ({used}/{max})',
    ...
    notePlaceholder: "La piscine, le petit-déjeuner, la vue…",
  ...
  de: {
    ...
    noMatches: "Keine Themen gefunden.",
    done: "Fertig",
    ...
    placeholder: "Tippen Sie auf „Neu erstellen\", um Ihre erste Bewertung zu schreiben.",
    generate: 'Erstellen',
    generateCount: 'Erstellen ({used}/{max})',
    ...
    notePlaceholder: 'Der Pool, das Frühstück, die Aussicht…',
  ...
  it: {
    ...
    searchTopics: "Cerca temi",
    noMatches: "Nessun tema corrisponde.",
    done: "Fatto",
    ...
    placeholder: "Tocca \"Rigenera\" per scrivere la tua prima recensione.",
    generate: 'Genera',
    generateCount: 'Genera ({used}/{max})',
    regenerate: 'Rigenera',
    ...
    notePlaceholder: 'La piscina, la colazione, la vista…',
  ...
  pt: {
    ...
    searchTopics: "Procurar temas",
    noMatches: "Nenhum tema corresponde.",
    done: "Concluído",
    ...
    placeholder: "Toque em \"Gerar outra\" para escrever a sua primeira avaliação.",
    generate: 'Gerar',
    generateCount: 'Gerar ({used}/{max})',
    ...
    notePlaceholder: 'A piscina, o pequeno-almoço, a vista…',
  ...
  nl: {
    ...
    searchTopics: "Onderwerpen zoeken",
    noMatches: "Geen onderwerpen gevonden.",
    done: "Klaar",
    ...
    placeholder: "Tik op \"Opnieuw\" om je eerste review te schrijven.",
    generate: 'Genereren',
    generateCount: 'Genereren ({used}/{max})',
    regenerate: 'Opnieuw',
    ...
    notePlaceholder: 'Het zwembad, het ontbijt, het uitzicht…',
